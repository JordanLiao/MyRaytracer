...
Scene::Scene() {
	...
	quadlight = QuadLight(glm::vec3(-0.6f, 1.45f, -0.6f), glm::vec3(-0.6f, 1.45f, 0.6f), glm::vec3(0.6f, 1.45f, 0.6f), glm::vec3(12.5f));
...
void Scene::setup() {
	...
	//Object* cube = ResourceManager::loadObject("Assets/cube.obj", true);
